...
$optionalsearchparameters1_cars = array("Mileage", "Transmission", "Engine Size", "Body Type", "Year");
$optionalsearchparameters2_cars = array("Year", "Transmission", "Mileage", "Body Type", "Engine Size");
$optionalsearchparameters3_cars = array("Body Type", "Transmission", "Mileage", "Year", "Engine Size");

$optionalsearchparameters1_houses = array("Beds", "Baths", "Size");
$optionalsearchparameters2_houses = array("Baths", "Beds", "Size");
$optionalsearchparameters3_houses = array("Size", "Beds", "Baths");
...
if (get_option('wp_site') == "Real Estate") {	
	$options[] = array( "name" => "Generic Contact form Shortcode (for listing detail pages, if no Agent)",
		"desc" => "Contact Form 7 Plugin shortcode for your 'generic' Listing contact form. If you have Agent (or 2) set for a listing, they will have their own Contact Form shortcode. (Enter the shortcode in the Agent post) This shortcode is 'generic' and used only when no Agent is specified for a listing.<br /><br /><span style='color: red;'>Important: Replace all double quote characters with single quote characters.</span>",
...
if (get_option('wp_site') == "Car Sales") {	
	$options[] = array( "name" => "Contact form Shortcode (for listing detail pages)",
		"desc" => "Contact Form 7 Plugin shortcode for the simple contact form on each listing detail page.<br /><br /><span style='color: red;'>Important: Replace all double quote characters with single quote characters.</span>",
		"id" => $shortname."_contactshortcode",
		"type" => "text",
		"std" => "");
}
...
$options[] = array( "name" => "Contact form Shortcode (for Contact Us page)",
	"desc" => "Contact Form 7 Plugin shortcode for the Contact Us page. To create this page, create a new Page, and choose the 'Contact' Page Template. <br /><br /><span style='color: red;'>Important: Replace all double quote characters with single quote characters.</span>",
...
$options[] = array( "name" => "Banner choices",
		"desc" => "Enter all possible banner choices. One banner per line.<br /><br />Optionally set a color for any banner. To do this, enter the 'pipe' character (|) and then the color. The color can be either a HEX value or English word, like 'Blue', 'Red', etc.<br /><br />Example:<br /><br />Sold|red<br />Reduced|#FFFFFF<br />Pending|Yellow<br /><br />Note: If you change the color for a banner, you must re-choose the banner from each listing and re-publish.<br /><br />If you choose 2 banner choices, the color is always taken from the first banner choice.",
...
if (get_option('wp_site') == "Car Sales") {
	...
	if (get_option('wp_site') == "Real Estate") {	
		...
		$options[] = array( "name" => "Size suffix",
			"desc" => "Text after the size. For example, Sq Ft, Acres, etc.",
	...
	$options[] = array( "name" => "Header for Search Results",
		"desc" => "Header text for the search results page",
...
if (get_option('wp_showvinquery') == "show") {
	$options[] = array( "name" => "VINquery.com Account Info (Required if you pull in VIN data from VINquery.com)",
						"type" => "heading");	
