...
remember( '[name=location_level1], [name=location_level2], [name=beds],[name=baths], [name=rentbuy], [name=propertytype], [name=resultsorder], [name=mls], [name=size], [name=lotsize], [name=openhouse], [name=garage], [name=resorcomm], [name=yearbuilt] ' );
