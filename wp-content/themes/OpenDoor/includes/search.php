			...
			<div class="accordion" id="accordion3">
				...
				<?php } ?>
					...
					<div class="accordion-group">
						...
						<div id="collapseTwoIdx" class="accordion-body collapse in">
							<div class="accordion-inner">
		...
		<?php if (get_option('wp_search') == "Both") { ?>
			...
			<?php } ?>
				  ...
				  <div class="accordion-group">
					...
					<div id="collapseThreeBoth" class="accordion-body collapse in">
					  <div class="accordion-inner">
							<?php include get_template_directory() . '/includes/customsearchform-houses.php' ?>
					  </div>
					</div>
			...
			<div class="accordion" id="accordion4">
				...
				<?php } ?>
					<div class="accordion-group">
						...
						<div id="collapseTwoCars" class="accordion-body collapse in">				
							<div class="accordion-inner">
